...
<div className="social-media">
				...
				<ul>
					<li>
						<a href="https://www.linkedin.com/in/elhambagheri91/" target="_blank">
						<i className="fa fa-linkedin"></i>
						</a>
					</li>
          <li>
						<a href="https://github.com/ElhamB" target="_blank">
							<i className="fa fa-github"></i>
						</a>
					</li>
					<li>
						<a href="https://api.whatsapp.com/send?phone=989351520241" target="_blank">
							<i className="fa fa-whatsapp "></i>
						</a>
					</li>
					<li>
						<a href="https://www.instagram.com/fersuweb/" target="_blank">
          ...
          <Image src="/images/eli.jpg" rounded/>
           </Col>
         </Row>
       </Container>
